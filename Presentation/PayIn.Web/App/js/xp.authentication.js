'use strict';
angular.module('xp.authentication', ['app', 'xp.communication'])
    .run(['$rootScope', 'xpAuthentication', function ($rootScope, xpAuthentication) {
        if (
            ...
            window.location.pathname === '/AccessControl/Public' ||
            window.location.pathname === '/AccessControl/Mupi'
        ) {
    ...
    .factory('xpAuthentication', ['xpCommunication', '$http', '$rootScope', '$q', function (xpCommunication, $http, $rootScope, $q) {
        ...
        return {
            ...
            'login': function () {
                if (history.back) { window.location.replace('/Account/Login'); }
