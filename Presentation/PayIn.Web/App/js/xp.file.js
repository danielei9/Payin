/*
 * bootstrap-filestyle
 * doc: http://markusslima.github.io/bootstrap-filemodelstyle/
 * github: https://github.com/markusslima/bootstrap-filestyle
 */

'use strict';
app
.directive('xpFile', [function () {
	function apply($scope, file, model) {
		$scope.files[model] = file;
		if (!$scope.$$phase)
			$scope.$apply();
	}
