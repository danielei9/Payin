...
app.controller('FullcalendarCtrl', ['$scope', function($scope) {
    ...
    $scope.events = [
      ...
      {title:'Repeating Event', start: new Date(y, m, d + 4, 16, 0), allDay: false, className: ['b-l b-2x b-warning'], location:'Home Town', info:'Repeat every day'},      
