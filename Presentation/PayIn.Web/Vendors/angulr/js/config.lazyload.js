...
angular.module('app')
  ...
  .constant('JQ_CONFIG', {
  	...
  	filestyle:    ['Vendors/angulr/vendor/jquery/file/bootstrap-filestyle.min.js'],
  	...
  	$ocLazyLoadProvider.config({
  		...
  		modules: [
				...
				},
				{
					...
					files: ['Vendors/angulr/vendor/modules/angular-file-upload/angular-file-upload.min.js']
				},
				{
					name: 'ui.calendar',
				...
				{
					name: 'ngImgCrop',
					files: ['Vendors/angulr/vendor/modules/ngImgCrop/ng-img-crop.js',
					        'Vendors/angulr/vendor/modules/ngImgCrop/ng-img-crop.css']
				},
				{
				...
				{
					name: 'textAngular',
					files: ['Vendors/angulr/vendor/modules/textAngular/textAngular-sanitize.min.js',
