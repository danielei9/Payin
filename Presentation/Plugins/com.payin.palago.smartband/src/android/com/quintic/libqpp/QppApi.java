...
public class QppApi {
	...
	public static void updateValueForNotification(BluetoothGatt bluetoothGatt,
		...
		if (qppData != null && qppData.length > 0)
			iQppCallback.onQppReceiveData(bluetoothGatt, strUUIDForNotifyChar,
					qppData);
	}
	...
	public static boolean qppEnable(BluetoothGatt bluetoothGatt, String qppServiceUUID, String writeCharUUID) {
		...
		if (bluetoothGatt == null || qppServiceUUID.isEmpty()
				|| writeCharUUID.isEmpty()) {
			Log.e(TAG, "invalid arguments");
			return false;
		}
	...
	public static boolean setQppNextNotify(BluetoothGatt bluetoothGatt,
