...
# Add your Azure account to the local PowerShell environment and credentials from AAD.
$userName = 'admin@pay-in.es'
$securePassword = ConvertTo-SecureString -String 'Pa$$w0rd,' -AsPlainText -Force 
