...
public class ServerDelete extends AsyncTask<String, Void, HashMap<String, String>> {

    private Context context;
    private ProgressDialog progreso = null;

    public AsyncResponse delegate = null;
    public boolean showProgress = true, cancelled = false;

    public ServerDelete(Context context){
    ...
    protected HashMap<String, String> doInBackground(String... params) {
        ...
        if (map != null) map.put("type", "delete");
