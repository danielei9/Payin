...
/*
public class TicketMobileGetWithPaymentMedias  implements Serializable {
    public ArrayList<TicketWithPaymentMedias> Data;

    public TicketMobileGetWithPaymentMedias() {
        Data = new ArrayList<>();
    }

    public static class TicketWithPaymentMedias {
        public Ticket Ticket;
        public ArrayList<PaymentMedia> PaymentMedias;
        public boolean HasPayment;

        public TicketWithPaymentMedias() {
    ...
    public static class PaymentMedia implements Serializable {
        public int     Id;
        public String  Title;
