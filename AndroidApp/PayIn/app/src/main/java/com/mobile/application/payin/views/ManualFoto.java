...
public class ManualFoto extends AppCompatActivity implements SurfaceHolder.Callback, View.OnClickListener, AsyncResponse {
        ...
        camera.takePicture(null, null, new Camera.PictureCallback() {
            ...
            public void onPictureTaken(byte[] data, Camera camera) {
                try {
                    ...
                    // Query de la foto
                    IncidentArguments.Item.Image = Base64.encodeToString(imageArray, 0);
