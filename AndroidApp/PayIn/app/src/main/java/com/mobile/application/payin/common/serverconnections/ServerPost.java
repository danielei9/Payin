...
public class ServerPost extends AsyncTask<String, Void, HashMap<String, String>> {
    private Context context;
    private ProgressDialog progreso;

    public AsyncResponse delegate = null;
    public boolean showProgress = true, cancelled = false, refresh = false;

    public ServerPost(Context context){
    ...
    protected HashMap<String, String> doInBackground(String... params) {
        ...
        if (map != null) map.put("type", "post");
        if (refresh) ServerRefresh.refreshToken(context);
