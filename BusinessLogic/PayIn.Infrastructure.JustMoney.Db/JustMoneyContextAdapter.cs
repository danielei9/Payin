...
{
	public class JustMoneyContextAdapter : IJustMoneyContext
	{
		private DbContextTransaction Transaction;
		private readonly JustMoneyContext Context;

		#region Constructors
		public JustMoneyContextAdapter(JustMoneyContext context)
		{
			if (context == null)
