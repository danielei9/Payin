...
{
	public class TranslationRepository : PublicRepository<Translation>
	{
		...
		public override IQueryable<Translation> CheckHorizontalVisibility(IQueryable<Translation> that)
		{
			return that
				//.Where(x =>
