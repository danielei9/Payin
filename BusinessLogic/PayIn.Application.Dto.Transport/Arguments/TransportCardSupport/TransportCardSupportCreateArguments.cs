...
{
	public class TransportCardSupportCreateArguments : IArgumentsBase
	{
		...
		#region Constructors
		public TransportCardSupportCreateArguments(string name, int ownerCode, string ownerName, int type, int subType)
		{
			Name = name;
			OwnerCode = ownerCode;
			OwnerName = ownerName;
