...
using PayIn.Application.JustMoney.Decorators;
...
namespace PayIn.Common.DI.JustMoney
{
	public static class DIConfig
	{
		...
		private static IEnumerable<KeyValuePair<Type, Type>> GetAssignsFromInterface(Type type)
		{
			var assemblies = new List<Assembly>() {
				...
				typeof(JustMoneyJustMoneyPrepaidCardGetAllArguments).Assembly, // PayIn.Application.Dto.JustMoney
				typeof(JustMoneyUnitOfWork).Assembly // PayIn.Repository.JustMoney
			};
		...
		private static IUnityContainer CreateContainer()
		{
			...
			.RegisterType<IUnitOfWork, JustMoneyUnitOfWork>(new PerResolveLifetimeManager())
