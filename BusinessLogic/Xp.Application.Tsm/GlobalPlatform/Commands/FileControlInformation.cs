...
*/
		...
		/// </summary>
		/// <param name="data">Global Platform Applet SELECT Command Response</param>
		public FileControlInformation(byte[] data)
		{
		...
		/// </summary>
		/// <param name="allInformation">All Value of File Control Information</param>
		public void SetAllInformation(byte[] allInformation)
		{
			AllInformation = new Tlv(allInformation);

			if (AllInformation.Tag != 0x6F)
				throw new ApplicationException("Invalid Select Response Tag (0x" + AllInformation.Tag.ToHexadecimal());
        }
	/*
