...
{
	public class M4mUpdateSmMetadataCommand : M4mCommand
	{
		#region Constructors
		public M4mUpdateSmMetadataCommand()
			:base(M4mCommand.UpdateSmMetadataSector)
		{
		}
		...
		public override async Task<string> ToHexadecimalAsync()
		{
			return await Task.Run(() => {
				var data = (
					"F0 F1 F2 F3 CF CE CD CC 84 85 86 87 4B 4A 49 48"
				)
				.Replace(" ", "");
				...
				var result =
					...
					(data2.Length / 2).ToHexadecimal(1) +
					data2;
