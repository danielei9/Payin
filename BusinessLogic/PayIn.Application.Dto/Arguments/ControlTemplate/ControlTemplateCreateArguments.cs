...
{
	public partial class ControlTemplateCreateArguments : IArgumentsBase
	{
		...
		[Display(Name="resources.controlTemplate.item")]         [Required]           public int        ItemId        { get; private set; }

		#region Constructors
		public ControlTemplateCreateArguments(string name, string observations, int itemId, XpDuration checkDuration, bool monday, bool tuesday, bool wednesday, bool thursday, bool friday, bool saturday, bool sunday)
		{
			Name = name ?? "";
