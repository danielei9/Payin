...
{
	public class DeviceMobileCreateHandler : IServiceBaseHandler<DeviceMobileCreateArguments>
	{
		...
		#region Constructors
		public DeviceMobileCreateHandler(
		...
		#region ExecuteAsync
		public async Task<dynamic> ExecuteAsync(DeviceMobileCreateArguments arguments)
		{
