...
{
	public class SystemCardMemberLockHandler :
		IServiceBaseHandler<SystemCardMemberLockArguments>
	{
		...
		#region ExecuteAsync
		public async Task<dynamic> ExecuteAsync(SystemCardMemberLockArguments arguments)
		{
			...
			systemCardMember.State = SystemCardMemberState.Blocked;
