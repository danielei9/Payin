...
{
	public class SabadellGatewayPaymentDto
	{
		...
		//#region Constructor
		//public SabadellGatewayPaymentDto(TicketPayArguments command, PaymentMedia paymentMedia, PaymentGateway paymentGateway, string commerceCode, string secretKey)
		//{
