...
{
	public class JustMoneyMobilePrepaidCardGetHandler : IQueryBaseHandler<JustMoneyMobilePrepaidCardGetArguments, JustMoneyApiPrepaidCardGetAllResult>
	{
		...
		#region ExecuteAsync
		public async Task<ResultBase<JustMoneyApiPrepaidCardGetAllResult>> ExecuteAsync(JustMoneyMobilePrepaidCardGetArguments arguments)
		{
