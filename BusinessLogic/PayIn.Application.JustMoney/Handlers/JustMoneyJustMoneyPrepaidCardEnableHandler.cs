...
{
	public class JustMoneyJustMoneyPrepaidCardEnableHandler : IServiceBaseHandler<JustMoneyJustMoneyPrepaidCardEnableArguments>
	{
		...
		#region ExecuteAsync
		public async Task<dynamic> ExecuteAsync(JustMoneyJustMoneyPrepaidCardEnableArguments arguments)
		{
			...
			// Change state
			await PfsService.ChangeCardStatusAsync(item.CardHolderId, cardInquiry.CardInfo.CardStatus, CardStatus.Open);
