...
{
	public class JustMoneyJustMoneyPrepaidCardDisableHandler : IServiceBaseHandler<JustMoneyJustMoneyPrepaidCardDisableArguments>
	{
		...
		#region ExecuteAsync
		public async Task<dynamic> ExecuteAsync(JustMoneyJustMoneyPrepaidCardDisableArguments arguments)
		{
