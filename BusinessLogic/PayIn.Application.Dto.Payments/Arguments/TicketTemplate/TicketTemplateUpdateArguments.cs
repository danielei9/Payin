...
{
	public class TicketTemplateUpdateArguments : IArgumentsBase
	{
		...
		#region Constructors
		public TicketTemplateUpdateArguments(int id, string name, string previousTextPosition, string backTextPosition, string regEx, int concessionId, DecimalCharDelimiter decimalCharDelimiter, int amountPosition, int? referencePosition, int? datePosition, string dateFormat, int? titlePosition, int? workerPosition, bool isGeneric)
		{
			Id = id;
			Name = name;
