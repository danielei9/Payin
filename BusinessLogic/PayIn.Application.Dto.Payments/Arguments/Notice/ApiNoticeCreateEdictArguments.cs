...
{
	public partial class ApiNoticeCreateEdictArguments : IArgumentsBase
	{
		...
		#region Constructors
		public ApiNoticeCreateEdictArguments (string shortDescription, string description, bool isVisible, NoticeVisibility visibility, decimal? longitude, decimal? latitude, string place, XpDateTime start, XpDateTime end, bool sendNotification)
		{
