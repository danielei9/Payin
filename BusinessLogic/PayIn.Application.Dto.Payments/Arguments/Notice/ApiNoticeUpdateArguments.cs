...
{
	public partial class ApiNoticeUpdateArguments : IArgumentsBase
	{
		...
		[Display(Name = "resources.notice.routeUrl")]
		public string RouteUrl { get; set; }

		[Display(Name = "resources.notice.routeUrl")]
		public byte[] RouteFileGPX { get; set; }

		public string RouteFileName { get; set; }

		#region Constructors
		public ApiNoticeUpdateArguments(int id, string shortDescription, string description, bool isVisible, NoticeVisibility visibility, NoticeState state, int? eventId, decimal? longitude, decimal? latitude, string place, XpDateTime start, XpDateTime end, bool sendNotification, string routeUrl, byte[] routeFileGPX, string routeFileName)
		{
			Id = id;
