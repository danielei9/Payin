...
{
	class CampaignLineAddProductHandler : 
		IServiceBaseHandler<CampaignLineAddProductArguments>
	{
		private readonly IEntityRepository<CampaignLine> Repository;
		private readonly IEntityRepository<Product> ProductRepository;

		#region Constructors
		public CampaignLineAddProductHandler(
		...
		#region ExecuteAsync
		public async Task<dynamic> ExecuteAsync(CampaignLineAddProductArguments arguments)
		{
