...
{
    public class AccountLineGetByCashHandler :
		IQueryBaseHandler<AccountLineGetByCashArguments, AccountLineGetByCashResult>
	{
		[Dependency] public ISessionData SessionData { get; set; }
        [Dependency] public IEntityRepository<AccountLine> Repository { get; set; }

		#region ExecuteAsync
		public async Task<ResultBase<AccountLineGetByCashResult>> ExecuteAsync(AccountLineGetByCashArguments arguments)
		{
            ...
            var result = items
                ...
                .ToList()
                .Select(x => new AccountLineGetByCashResult
                {
                    Id = x.Id,
            ...
            return new AccountLineGetByCashResultBase
            {
                Data = result,
