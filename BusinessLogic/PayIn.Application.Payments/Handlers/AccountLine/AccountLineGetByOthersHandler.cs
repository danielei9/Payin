...
{
    public class AccountLineGetByOthersHandler :
		IQueryBaseHandler<AccountLineGetByOthersArguments, AccountLineGetByOthersResult>
	{
		[Dependency] public ISessionData SessionData { get; set; }
        [Dependency] public IEntityRepository<AccountLine> Repository { get; set; }

		#region ExecuteAsync
		public async Task<ResultBase<AccountLineGetByOthersResult>> ExecuteAsync(AccountLineGetByOthersArguments arguments)
		{
            ...
            var result = items
                ...
                .ToList()
                .Select(x => new AccountLineGetByOthersResult
                {
                    Id = x.Id,
            ...
            return new AccountLineGetByOthersResultBase
            {
                Data = result,
