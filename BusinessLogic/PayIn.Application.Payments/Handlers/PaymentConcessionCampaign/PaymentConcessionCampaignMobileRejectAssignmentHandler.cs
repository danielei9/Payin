...
{
	public class PaymentConcessionCampaignMobileRejectAssignmentHandler : IServiceBaseHandler<PaymentConcessionCampaignMobileRejectAssignmentArguments>
	{
		...
		#region Constructors
		public PaymentConcessionCampaignMobileRejectAssignmentHandler(
		...
		#region ExecuteAsync
		public async Task<dynamic> ExecuteAsync(PaymentConcessionCampaignMobileRejectAssignmentArguments arguments)
		{
			...
			item.Item.State = PaymentConcessionCampaignState.Deleted;
			...
			await ServiceNotificationCreate.ExecuteAsync(new ServiceNotificationCreateArguments(
				...
				message: PaymentConcessionCampaignResources.AssociationRefused.FormatString(item.Name, item.CampaignName),
