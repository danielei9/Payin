...
{
	public class MobileEntranceLoadTextHandler :
		IServiceBaseHandler<MobileEntranceLoadTextArguments>
	{
		[Dependency] public IEntityRepository<Entrance> EntranceRepository { get; set; }
		[Dependency] public ISessionData SessionData { get; set; }
		[Dependency] public MobileEntranceCheckCreateTextHandler MobileEntranceCheckCreateTextHandler { get; set; }

		#region ExecuteAsync
		public async Task<dynamic> ExecuteAsync(MobileEntranceLoadTextArguments arguments)
		{
			var now = DateTime.UtcNow;

			// Obtener codes
			var codes = await MobileEntranceCheckCreateTextHandler.GetEntranceInfoFromCodeTextAsync(arguments.Code);
			if (codes.Event == null)
